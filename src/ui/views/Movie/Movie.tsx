...
export const Movie = () => {
  ...
  const {movie} = useGetMovieDetail(() => movieDetailService.getMovieDetail(movieId))
    ...
    <div className={style.container}>
      <div className={style.header}>
        ...
        <div className={style.header_img_container}>
          <img className={style.header_image} src={imgUrl + movie.backdrop_path } alt="" />
        </div>
      ...
      <main className={style.movie_info_container}>
        <figure className={style.poster_container}>
          <img className={style.poster} src={process.env.REACT_APP_POSTER_IMAGE + movie.poster_path} alt="" />
        </figure>
